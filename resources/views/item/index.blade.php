      ...
      @foreach ($items as $item)
         <a href="{{ route('item.show', $item->item_id) }}" class="text-decoration-none text-black">
            <div class="d-flex gap-2 shadow py-2 px-3 align-items-center">
               <img
                  src="https://s3.bukalapak.com/bukalapak-kontenz-production/content_attachments/86533/original/manfaat_buah_apel.jpg"
                  alt="" width="120px" height="120px" class="border-circle">
